...
export default function User() {
  ...
  const handleSubmitChange = (e) => {
    e.preventDefault()
    update(ref(db, `PlasticContribution/${realtimeId}`), {
      fullname,
      time,
      address,
      number,
    ...
    <div className="user">
      ...
      <div className="userContainer">
        <div className="userShow">
          ...
          <div className="userShowBottom">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">{dataFilter.contributionID}</span>
            </div>
        ...
        <div className="userUpdate">
          <div className='alert'>
        {edit && <Alert severity="success" sx={{width:"250px",fontSize:"18px",justifyContent:"center",color:'white', backgroundColor:"#4C9865"}} >
