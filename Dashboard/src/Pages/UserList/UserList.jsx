...
const handleDeleteSelectedRows =  async() =>{
  const result = await confirm("Are you sure you to get rid of this row data ?",options);
   if(result) {
  ...
  const columns = [
    ...
    { field: 'profileLink', headerName: 'Profile ', width: 200,renderCell:(params) =>{
      return(
        <>
          <img src={params.row.profileLink} alt='' width='30px' height='30px'/>
        </>
      )
    } },
